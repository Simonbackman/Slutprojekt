...
CREATE TABLE reservation (id int(8) PRIMARY KEY AUTO_INCREMENT, name varchar(32), phone int(8), antal int(8), date varchar(32), time varchar(32) , bordnr int(8) UNIQUE);